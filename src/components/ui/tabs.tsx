...
>(({ className, ...props }, ref) => (
  <TabsPrimitive.List
    ref={ref}
    className={cn(
      "inline-flex h-12 items-center justify-center rounded-md bg-muted/50 p-1.5 text-muted-foreground shadow-sm",
      className
    )}
    {...props}
  />
